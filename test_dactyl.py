...
keyboard.keymap = [
    ...
    KC.LSHIFT, KC.Z,       KC.X,        KC.C,       KC.V,       KC.B,       #            KC.RBRC,                         KC.HOME,    KC.N,       KC.M,       KC.COMMA,   KC.DOT,     KC.SLSH,    KC.RSHIFT,
                                                                            #
    XXXXX,      KC.LGUI,      XXXXX,      XXXXX,      KC.LBRC,    KC.RBRC,    #   KC.LCTRL,  tog_lay2,  KC.LGUI,     KC.LALT,  KC.LSHIFT,   KC.HT(KC.ENTER, tog_lay2),   KC.SPACE,   KC.BSPC, KC.HT(KC.DEL, tog_lay1), KC.LSHIFT,   KC.RALT,     KC.RGUI,    tog_lay2,    KC.RCTRL,
    
    KC.HT(KC.ENTER, tog_lay2),KC.SPACE, KC.LCTRL,KC.LALT, XXXXX,XXXXX,
    ],
