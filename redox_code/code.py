...
keyboard.keymap = [
    ...
    _____,    _____,      KC.UP,      _____,      _____,      _____,       _____,                          _____,    _____,      _____,      _____,      _____,      _____,       _____,

    _____,    KC.LEFT,    KC.DOWN,    KC.RGHT,  _____,      _____,       _____,                          _____,    KC.LEFT,      KC.DOWN,      KC.UP,     KC.RGHT,      _____,       _____,
